  ...
  override def doCast(value: Ast.expr, typeName: DataType): String =
    config.cppConfig.pointers match {
      ...
      case SharedPointers =>
        typeName match {
          case ut: UserType =>
            s"std::static_pointer_cast<${AwkwardCompiler.types2class(ut.classSpec.get.name)}>(${translate(value)})"
